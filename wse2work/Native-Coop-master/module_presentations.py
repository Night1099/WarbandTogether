...
##        (gt, ":total_wage", 0),
  ...
  ("coop_assign_drop_to_group_member", prsntf_manual_end_only, 0, [
    ...
    # OLD: multiplayer_campaign_inventory_window replaced by native inventory screen + gate presentation
    ("coop_inventory_gate", prsntf_read_only, 0, [
        (ti_on_presentation_load, [
            (presentation_set_duration, 999999),
            # Invisible gate -- no background mesh, no overlays.
            # Sync completes within 1-2 ticks on LAN, so nothing is visible.
        ]),
        (ti_on_presentation_run, [
            # Poll every tick for sync completion
            (try_begin),
                (eq, "$g_coop_inv_sync_ready", 1),
                # Bag slots are now in the troop struct.
                # Snapshot equipment slots 0-9 for close-diff baseline.
                ...
                (try_end),
                # Snapshot empty bag slots as -1 to match troop_get_inventory_slot.
                # Non-empty bag slots were snapshotted by the inv_bag_slot receive handler.
                (try_for_range, ":slot", 10, 106),
                    ...
                    (try_begin),
                        ...
                        (troop_set_slot, "trp_temp_troop", ":snap_item", -1),
                        (store_add, ":snap_mod", slot_coop_inv_snap_bag_mod_begin, ":offset"),
                        (troop_set_slot, "trp_temp_troop", ":snap_mod", 0),
                    (try_end),
                (try_end),
                # Set bypass flag and close gate
                (assign, "$g_coop_inv_gate_passed", 1),
                (presentation_set_duration, 0),
                (display_message, "@Inventory loaded. Press I to open."),
            (try_end),
        ]),
    ]),
    ...
    ("multiplayer_campaign_character_window", 0, mesh_load_window, [
        (ti_on_presentation_load, [
            ...
            # Get player's campaign troop
            (multiplayer_get_my_player, ":player_no"),
            (player_get_troop_id, "$g_coop_char_screen_troop", ":player_no"),
            (assign, ":troop_no", "$g_coop_char_screen_troop"),

            # --- Header: Name, Level, XP ---
            (str_store_troop_name, s1, ":troop_no"),
            # Use server-pushed XP/level from trp_temp_troop slots
            (troop_get_slot, reg1, "trp_temp_troop", slot_coop_char_level),
            (troop_get_slot, reg2, "trp_temp_troop", slot_coop_char_xp),
            (str_store_string, s0, "@{s1}  --  Level: {reg1}  XP: {reg2}"),
            ...
            # --- Points summary ---
            (troop_get_attribute_points, reg1, ":troop_no"),
            (troop_get_skill_points, reg2, ":troop_no"),
            (troop_get_proficiency_points, reg3, ":troop_no"),
            (str_store_string, s0, "@Points  --  Attributes: {reg1}   Skills: {reg2}   Proficiency: {reg3}"),
            (create_text_overlay, "$g_coop_char_points_text", s0, tf_center_justify),
            (overlay_set_color, "$g_coop_char_points_text", 0x00FF00),
            (position_set_x, pos1, 500),
            (position_set_y, pos1, 680),
            (overlay_set_position, "$g_coop_char_points_text", pos1),

            # Cache point counts for button visibility
            ...
            # ================================================================
            (str_clear, s0),
            (create_text_overlay, "$g_coop_char_skills_container", s0, tf_scrollable),
            (position_set_x, pos1, 50),
            (position_set_y, pos1, 80),
            (overlay_set_position, "$g_coop_char_skills_container", pos1),
            (position_set_x, pos1, 500),
            (position_set_y, pos1, 590),
            (overlay_set_area_size, "$g_coop_char_skills_container", pos1),
            (set_container_overlay, "$g_coop_char_skills_container"),

            # Content height: 4 attrs + 24 skills = 28 rows at 25px + 4 attr headers at 35px gap
            # Total ~ 28*25 + 4*10 = 740. Start y at 740 so content scrolls upward.
            (assign, ":y", 730),

            # ------ STRENGTH ------
            (store_attribute_level, reg1, ":troop_no", ca_strength),
            (str_store_string, s0, "@Strength: {reg1}"),
            (create_text_overlay, "$g_coop_char_attr_str_text", s0, tf_with_outline),
            (overlay_set_color, "$g_coop_char_attr_str_text", 0xFFCC00),
            (position_set_x, pos1, 10),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_attr_str_text", pos1),
            (create_button_overlay, "$g_coop_char_btn_str", "@+", 0),
            (position_set_x, pos1, 210),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_str", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_str", pos1),
            (try_begin),
                (le, ":attr_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_str", 0),
            (try_end),
            (val_sub, ":y", 28),

            # Ironflesh (36)
            (store_skill_level, reg1, skl_ironflesh, ":troop_no"),
            (str_store_string, s0, "@Ironflesh: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s36", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s36", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s36", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s36", 0),
            (try_end),
            (val_sub, ":y", 25),

            # Power Strike (35)
            (store_skill_level, reg1, skl_power_strike, ":troop_no"),
            (str_store_string, s0, "@Power Strike: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s35", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s35", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s35", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s35", 0),
            (try_end),
            (val_sub, ":y", 25),

            # Power Draw (33)
            (store_skill_level, reg1, skl_power_draw, ":troop_no"),
            (str_store_string, s0, "@Power Draw: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s33", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s33", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s33", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s33", 0),
            (try_end),
            (val_sub, ":y", 25),

            # Power Throw (34)
            (store_skill_level, reg1, skl_power_throw, ":troop_no"),
            (str_store_string, s0, "@Power Throw: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s34", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s34", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s34", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s34", 0),
            (try_end),
            (val_sub, ":y", 35),

            # ------ AGILITY ------
            (store_attribute_level, reg1, ":troop_no", ca_agility),
            (str_store_string, s0, "@Agility: {reg1}"),
            (create_text_overlay, "$g_coop_char_attr_agi_text", s0, tf_with_outline),
            (overlay_set_color, "$g_coop_char_attr_agi_text", 0xFFCC00),
            (position_set_x, pos1, 10),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_attr_agi_text", pos1),
            (create_button_overlay, "$g_coop_char_btn_agi", "@+", 0),
            (position_set_x, pos1, 210),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_agi", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_agi", pos1),
            (try_begin),
                (le, ":attr_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_agi", 0),
            (try_end),
            (val_sub, ":y", 28),

            # Weapon Master (27)
            (store_skill_level, reg1, skl_weapon_master, ":troop_no"),
            (str_store_string, s0, "@Weapon Master: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s27", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s27", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s27", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s27", 0),
            (try_end),
            (val_sub, ":y", 25),

            # Shield (26)
            (store_skill_level, reg1, skl_shield, ":troop_no"),
            (str_store_string, s0, "@Shield: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s26", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s26", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s26", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s26", 0),
            (try_end),
            (val_sub, ":y", 25),

            # Athletics (25)
            (store_skill_level, reg1, skl_athletics, ":troop_no"),
            (str_store_string, s0, "@Athletics: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s25", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s25", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s25", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s25", 0),
            (try_end),
            (val_sub, ":y", 25),

            # Riding (24)
            (store_skill_level, reg1, skl_riding, ":troop_no"),
            (str_store_string, s0, "@Riding: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s24", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s24", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s24", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s24", 0),
            (try_end),
            (val_sub, ":y", 25),

            # Horse Archery (23)
            (store_skill_level, reg1, skl_horse_archery, ":troop_no"),
            (str_store_string, s0, "@Horse Archery: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s23", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s23", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s23", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s23", 0),
            (try_end),
            (val_sub, ":y", 25),

            # Looting (22)
            (store_skill_level, reg1, skl_looting, ":troop_no"),
            (str_store_string, s0, "@Looting: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s22", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s22", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s22", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s22", 0),
            (try_end),
            (val_sub, ":y", 35),

            # ------ INTELLIGENCE ------
            (store_attribute_level, reg1, ":troop_no", ca_intelligence),
            (str_store_string, s0, "@Intelligence: {reg1}"),
            (create_text_overlay, "$g_coop_char_attr_int_text", s0, tf_with_outline),
            (overlay_set_color, "$g_coop_char_attr_int_text", 0xFFCC00),
            (position_set_x, pos1, 10),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_attr_int_text", pos1),
            (create_button_overlay, "$g_coop_char_btn_int", "@+", 0),
            (position_set_x, pos1, 210),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_int", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_int", pos1),
            (try_begin),
                (le, ":attr_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_int", 0),
            (try_end),
            (val_sub, ":y", 28),

            # Trainer (17)
            (store_skill_level, reg1, skl_trainer, ":troop_no"),
            (str_store_string, s0, "@Trainer: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s17", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s17", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s17", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s17", 0),
            (try_end),
            (val_sub, ":y", 25),

            # Tracking (16)
            (store_skill_level, reg1, skl_tracking, ":troop_no"),
            (str_store_string, s0, "@Tracking: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s16", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s16", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s16", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s16", 0),
            (try_end),
            (val_sub, ":y", 25),

            # Tactics (15)
            (store_skill_level, reg1, skl_tactics, ":troop_no"),
            (str_store_string, s0, "@Tactics: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s15", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s15", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s15", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s15", 0),
            (try_end),
            (val_sub, ":y", 25),

            # Pathfinding (14)
            (store_skill_level, reg1, skl_pathfinding, ":troop_no"),
            (str_store_string, s0, "@Pathfinding: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s14", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s14", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s14", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s14", 0),
            (try_end),
            (val_sub, ":y", 25),

            # Spotting (13)
            (store_skill_level, reg1, skl_spotting, ":troop_no"),
            (str_store_string, s0, "@Spotting: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s13", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s13", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s13", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s13", 0),
            (try_end),
            (val_sub, ":y", 25),

            # Inventory Mgmt (12)
            (store_skill_level, reg1, skl_inventory_management, ":troop_no"),
            (str_store_string, s0, "@Inventory Mgmt: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s12", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s12", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s12", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s12", 0),
            (try_end),
            (val_sub, ":y", 25),

            # Wound Treatment (11)
            (store_skill_level, reg1, skl_wound_treatment, ":troop_no"),
            (str_store_string, s0, "@Wound Treatment: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s11", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s11", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s11", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s11", 0),
            (try_end),
            (val_sub, ":y", 25),

            # Surgery (10)
            (store_skill_level, reg1, skl_surgery, ":troop_no"),
            (str_store_string, s0, "@Surgery: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s10", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s10", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s10", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s10", 0),
            (try_end),
            (val_sub, ":y", 25),

            # First Aid (9)
            (store_skill_level, reg1, skl_first_aid, ":troop_no"),
            (str_store_string, s0, "@First Aid: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s9", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s9", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s9", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s9", 0),
            (try_end),
            (val_sub, ":y", 25),

            # Engineer (8)
            (store_skill_level, reg1, skl_engineer, ":troop_no"),
            (str_store_string, s0, "@Engineer: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s8", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s8", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s8", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s8", 0),
            (try_end),
            (val_sub, ":y", 35),

            # ------ CHARISMA ------
            (store_attribute_level, reg1, ":troop_no", ca_charisma),
            (str_store_string, s0, "@Charisma: {reg1}"),
            (create_text_overlay, "$g_coop_char_attr_cha_text", s0, tf_with_outline),
            (overlay_set_color, "$g_coop_char_attr_cha_text", 0xFFCC00),
            (position_set_x, pos1, 10),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_attr_cha_text", pos1),
            (create_button_overlay, "$g_coop_char_btn_cha", "@+", 0),
            (position_set_x, pos1, 210),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_cha", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_cha", pos1),
            (try_begin),
                (le, ":attr_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_cha", 0),
            (try_end),
            (val_sub, ":y", 28),

            # Persuasion (7)
            (store_skill_level, reg1, skl_persuasion, ":troop_no"),
            (str_store_string, s0, "@Persuasion: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s7", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s7", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s7", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s7", 0),
            (try_end),
            (val_sub, ":y", 25),

            # Prisoner Mgmt (2)
            (store_skill_level, reg1, skl_prisoner_management, ":troop_no"),
            (str_store_string, s0, "@Prisoner Mgmt: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s2", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s2", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s2", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s2", 0),
            (try_end),
            (val_sub, ":y", 25),

            # Leadership (1)
            (store_skill_level, reg1, skl_leadership, ":troop_no"),
            (str_store_string, s0, "@Leadership: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s1", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s1", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s1", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s1", 0),
            (try_end),
            (val_sub, ":y", 25),

            # Trade (0)
            (store_skill_level, reg1, skl_trade, ":troop_no"),
            (str_store_string, s0, "@Trade: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 30),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, reg0, pos1),
            (create_button_overlay, "$g_coop_char_btn_s0", "@+", 0),
            (position_set_x, pos1, 280),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_char_btn_s0", pos1),
            (position_set_x, pos1, 700),
            (position_set_y, pos1, 700),
            (overlay_set_size, "$g_coop_char_btn_s0", pos1),
            (try_begin),
                (le, ":skill_pts", 0),
                (overlay_set_display, "$g_coop_char_btn_s0", 0),
            (try_end),

            (set_container_overlay, -1),

            # ================================================================
            # RIGHT COLUMN: Weapon Proficiencies (fixed, not scrollable)
            # ================================================================
            (create_text_overlay, reg0, "@WEAPON PROFICIENCIES", tf_with_outline),
            (overlay_set_color, reg0, 0xFFCC00),
            (position_set_x, pos1, 600),
            (position_set_y, pos1, 650),
            (overlay_set_position, reg0, pos1),
            ...
            (store_proficiency_level, reg1, ":troop_no", wpt_one_handed_weapon),
            (str_store_string, s0, "@One-Handed: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 610),
            (position_set_y, pos1, ":wp_y"),
            (overlay_set_position, reg0, pos1),
            (val_sub, ":wp_y", 25),

            (store_proficiency_level, reg1, ":troop_no", wpt_two_handed_weapon),
            (str_store_string, s0, "@Two-Handed: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 610),
            (position_set_y, pos1, ":wp_y"),
            (overlay_set_position, reg0, pos1),
            ...
            (store_proficiency_level, reg1, ":troop_no", wpt_polearm),
            (str_store_string, s0, "@Polearm: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 610),
            (position_set_y, pos1, ":wp_y"),
            (overlay_set_position, reg0, pos1),
            ...
            (store_proficiency_level, reg1, ":troop_no", wpt_archery),
            (str_store_string, s0, "@Archery: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 610),
            (position_set_y, pos1, ":wp_y"),
            (overlay_set_position, reg0, pos1),
            ...
            (store_proficiency_level, reg1, ":troop_no", wpt_crossbow),
            (str_store_string, s0, "@Crossbow: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 610),
            (position_set_y, pos1, ":wp_y"),
            (overlay_set_position, reg0, pos1),
            ...
            (store_proficiency_level, reg1, ":troop_no", wpt_throwing),
            (str_store_string, s0, "@Throwing: {reg1}"),
            (create_text_overlay, reg0, s0, 0),
            (position_set_x, pos1, 610),
            (position_set_y, pos1, ":wp_y"),
            (overlay_set_position, reg0, pos1),
            ...
            # --- Done button ---
            (create_button_overlay, "$g_coop_char_close_btn", "@Done", tf_center_justify),
            (position_set_x, pos1, 750),
            (position_set_y, pos1, 50),
            (overlay_set_position, "$g_coop_char_close_btn", pos1),
        ]),
        ...
        (ti_on_presentation_event_state_change, [
            ...
            (store_trigger_param_2, ":value"),
            (try_begin),
                (eq, ":object", "$g_coop_char_close_btn"),
                (presentation_set_duration, 0),
            # --- Attribute [+] buttons ---
            (else_try),
                (eq, ":object", "$g_coop_char_btn_str"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_attribute, ca_strength),
            (else_try),
                (eq, ":object", "$g_coop_char_btn_agi"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_attribute, ca_agility),
            (else_try),
                (eq, ":object", "$g_coop_char_btn_int"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_attribute, ca_intelligence),
            (else_try),
                (eq, ":object", "$g_coop_char_btn_cha"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_attribute, ca_charisma),
            # --- Skill [+] buttons ---
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s36"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 36), # ironflesh
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s35"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 35), # power strike
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s33"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 33), # power draw
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s34"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 34), # power throw
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s27"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 27), # weapon master
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s26"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 26), # shield
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s25"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 25), # athletics
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s24"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 24), # riding
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s23"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 23), # horse archery
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s22"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 22), # looting
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s1"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 1), # leadership
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s2"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 2), # prisoner mgmt
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s12"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 12), # inventory mgmt
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s7"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 7), # persuasion
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s8"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 8), # engineer
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s9"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 9), # first aid
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s10"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 10), # surgery
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s11"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 11), # wound treatment
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s0"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 0), # trade
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s13"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 13), # spotting
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s14"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 14), # pathfinding
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s15"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 15), # tactics
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s16"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 16), # tracking
            (else_try),
                (eq, ":object", "$g_coop_char_btn_s17"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_raise_skill, 17), # trainer
            (try_end),
        ]),
    ...
    ("multiplayer_campaign_character_creation", 0, mesh_load_window, [
        (ti_on_presentation_load, [
            (set_fixed_point_multiplier, 1000),
            (presentation_set_duration, 999999),

            # Step is set before presentation opens (by first_join handler or step advance)
            (assign, "$g_coop_creation_done", 0),
            (call_script, "script_coop_creation_show_step"),
        ]),
        ...
        (ti_on_presentation_event_state_change, [
            ...
            (try_begin),
                ...
                (try_begin),
                    (eq, ":object", "$g_coop_creation_opt_0"),
                    (assign, "$g_coop_creation_gender", 0), # male
                    (assign, "$g_coop_creation_step", 1),
                    (presentation_set_duration, 0),
                    (start_presentation, "prsnt_multiplayer_campaign_character_creation"),
                (else_try),
                    (eq, ":object", "$g_coop_creation_opt_1"),
                    (assign, "$g_coop_creation_gender", 1), # female
                    (assign, "$g_coop_creation_step", 1),
                    (presentation_set_duration, 0),
                    (start_presentation, "prsnt_multiplayer_campaign_character_creation"),
                (try_end),
            ...
            (else_try),
                ...
                (try_for_range, ":i", 0, 6),
                    (store_add, ":btn_slot", ":i", 60),
                    (troop_get_slot, ":btn_id", "trp_temp_array_a", ":btn_slot"),
                    (eq, ":object", ":btn_id"),
                    (store_add, "$g_coop_creation_father", ":i", 1), # cb_noble=1 through cb_thief=6
                    (assign, "$g_coop_creation_step", 2),
                    (presentation_set_duration, 0),
                    (start_presentation, "prsnt_multiplayer_campaign_character_creation"),
                (try_end),
            # Early life step (step 2)
            (else_try),
                ...
                (try_for_range, ":i", 0, 5),
                    ...
                    (troop_get_slot, ":btn_id", "trp_temp_array_a", ":btn_slot"),
                    (eq, ":object", ":btn_id"),
                    (assign, "$g_coop_creation_earlylife", ":i"),
                    (assign, "$g_coop_creation_step", 3),
                    (presentation_set_duration, 0),
                    (start_presentation, "prsnt_multiplayer_campaign_character_creation"),
                (try_end),
            # Young adulthood step (step 3)
            (else_try),
                ...
                (try_for_range, ":i", 0, 7),
                    ...
                    (troop_get_slot, ":btn_id", "trp_temp_array_a", ":btn_slot"),
                    (eq, ":object", ":btn_id"),
                    (assign, "$g_coop_creation_adulthood", ":i"),
                    (assign, "$g_coop_creation_step", 4),
                    (presentation_set_duration, 0),
                    (start_presentation, "prsnt_multiplayer_campaign_character_creation"),
                (try_end),
            # Reason step (step 4)
            (else_try),
                ...
                (try_for_range, ":i", 0, 5),
                    ...
                    (troop_get_slot, ":btn_id", "trp_temp_array_a", ":btn_slot"),
                    (eq, ":object", ":btn_id"),
                    (assign, "$g_coop_creation_reason", ":i"),
                    # Flag for ti_on_presentation_run to send and close
                    (assign, "$g_coop_creation_done", 1),
                (try_end),
            (try_end),
        ]),
        ...
        (ti_on_presentation_run, [
            (store_trigger_param_1, ":cur_time"),
            (try_begin),
                (eq, "$g_coop_creation_done", 1),
                (assign, "$g_coop_creation_done", 0),
                (multiplayer_send_4_int_to_server, multiplayer_event_multiplayer_campaign_client_events, multiplayer_event_multiplayer_campaign_char_creation_bg, "$g_coop_creation_gender", "$g_coop_creation_father", "$g_coop_creation_earlylife"),
                (multiplayer_send_3_int_to_server, multiplayer_event_multiplayer_campaign_client_events, multiplayer_event_multiplayer_campaign_char_creation_life, "$g_coop_creation_adulthood", "$g_coop_creation_reason"),
                (display_message, "@Character created! Welcome to Calradia."),
                (presentation_set_duration, 0),
            (try_end),
        ]),
    ]),

    ("multiplayer_campaign_map_spawn_picker", 0, mesh_load_window, [
        (ti_on_presentation_load, [
            (set_fixed_point_multiplier, 1000),
            (presentation_set_duration, 999999),

            (create_text_overlay, reg0, "@Choose your starting region:", tf_center_justify|tf_with_outline),
            (overlay_set_color, reg0, 0xFFFFFF),
            (position_set_x, pos1, 500),
            (position_set_y, pos1, 700),
            (overlay_set_position, reg0, pos1),
            ...
            (assign, ":y", 620),
            (create_button_overlay, "$g_coop_spawn_opt_0", "@Praven (Swadia)", 0),
            (position_set_x, pos1, 300),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_spawn_opt_0", pos1),
            (val_sub, ":y", 45),
            (create_button_overlay, "$g_coop_spawn_opt_1", "@Reyvadin (Vaegirs)", 0),
            (position_set_x, pos1, 300),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_spawn_opt_1", pos1),
            (val_sub, ":y", 45),
            (create_button_overlay, "$g_coop_spawn_opt_2", "@Tulga (Khergits)", 0),
            (position_set_x, pos1, 300),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_spawn_opt_2", pos1),
            (val_sub, ":y", 45),
            (create_button_overlay, "$g_coop_spawn_opt_3", "@Sargoth (Nords)", 0),
            (position_set_x, pos1, 300),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_spawn_opt_3", pos1),
            (val_sub, ":y", 45),
            (create_button_overlay, "$g_coop_spawn_opt_4", "@Jelkala (Rhodoks)", 0),
            (position_set_x, pos1, 300),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_spawn_opt_4", pos1),
            (val_sub, ":y", 45),
            (create_button_overlay, "$g_coop_spawn_opt_5", "@Shariz (Sarranids)", 0),
            (position_set_x, pos1, 300),
            (position_set_y, pos1, ":y"),
            (overlay_set_position, "$g_coop_spawn_opt_5", pos1),
        ]),
        ...
        (ti_on_presentation_event_state_change, [
            ...
            (store_trigger_param_2, ":value"),
            (try_begin),
                (eq, ":object", "$g_coop_spawn_opt_0"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_map_spawn_choice, 0),
                (presentation_set_duration, 0),
            (else_try),
                (eq, ":object", "$g_coop_spawn_opt_1"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_map_spawn_choice, 1),
                (presentation_set_duration, 0),
            (else_try),
                (eq, ":object", "$g_coop_spawn_opt_2"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_map_spawn_choice, 2),
                (presentation_set_duration, 0),
            (else_try),
                (eq, ":object", "$g_coop_spawn_opt_3"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_map_spawn_choice, 3),
                (presentation_set_duration, 0),
            (else_try),
                (eq, ":object", "$g_coop_spawn_opt_4"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_map_spawn_choice, 4),
                (presentation_set_duration, 0),
            (else_try),
                (eq, ":object", "$g_coop_spawn_opt_5"),
                (multiplayer_send_2_int_to_server, multiplayer_event_coop_send_to_server, coop_event_map_spawn_choice, 5),
                (presentation_set_duration, 0),
            (try_end),
        ]),
