...
("prison_cart_door_left", sokf_show_hit_point_bar|sokf_destructible|sokf_moveable,"prison_cart_door_left","bo_prison_cart_door_left",
 [
  ...
  ("coop_inventory",sokf_type_container|sokf_place_at_origin,"package","bobaggage", []),
  ("1257_castle_f_door_a",sokf_moveable|sokf_show_hit_point_bar|sokf_destructible,"castle_f_door_a","bo_castle_f_door_a", []),
  ("1257_earth_gate",sokf_moveable|sokf_show_hit_point_bar|sokf_destructible,"earth_gate_a","bo_earth_gate_a", []),
  ("1257_hit_spot_2m",0,"0","0", []),
  ("1257_hit_spot_4m",0,"0","0", []),
  ("1257_portcullis",sokf_moveable,"portcullis_a","bo_portcullis_a", []),
  ("1257_tavern_door_a",sokf_moveable,"tavern_door_a","bo_tavern_door_a", []),
  ("1257_tavern_door_b",sokf_moveable,"tavern_door_b","bo_tavern_door_b", []),
  ("bushes10_a",0,"bush_a","0", []),
  ("bushes10_c",0,"bush_c","0", []),
  ("desert_tree_aa",0,"tree_a","0", []),
  ("palm_aa",0,"palm","0", []),
  ("pine_1_b",0,"pine_1","0", []),
  ("rock1",0,"rock","0", []),
  ("seedy_plant_a",0,"plant_a","0", []),
  ("test_helmet",0,"0","0", []),
  ("tree_14_a",0,"tree_a","0", []),
  ("tree_16_a",0,"tree_a","0", []),
  ("tree_8_a",0,"tree_a","0", []),
  ("tree_snowy_a",0,"tree_a","0", []),
  ("valleyRock_flatRounded_small_1",0,"rock","0", []),
#INVASION MODE END
